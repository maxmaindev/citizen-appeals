...
# Script to clear seeded data (appeals and related data)
# This will delete all appeals, comments, photos, notifications, and appeal history
# It will NOT delete users, categories, or services
...
echo "⚠️  WARNING: This will DELETE ALL appeals and related data!"
echo "This includes:"
echo "  - All appeals"
echo "  - All comments"
echo "  - All photos"
